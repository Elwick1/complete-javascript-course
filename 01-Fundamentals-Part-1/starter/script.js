...
// // Operator Precedence
// const notNow = 2037;
// const ageJJonas = now - 1991;
// const ageSSarah = now - 2018;
// console.log(now - 1991 > now - 2018);
// // let x, y;
...
// const markBMI = markHeight / markWeight ** 2;
// const johnBMI = johnHeight / (johnWeight * johnHeight);
...
// }
// else {
//     console.log('nope john is bigger than mark')
// }

// console.log(`'hey! so it looks like mark has a bmi of ${markBMI}
// and john has a bmi of ${johnBMI}`)
...
3. BONUS 1: Include a requirement for a minimum score of 100.
 With this rule, a team only wins if it has a higher score
  than the other team, and the same time a score of at
   least 100 points. HINT: Use a logical operator to test
...
//     console.log(`'Koalas win with an average score of ${koalaAverageScore}!`)
// }
// else {
//     console.log(`Looks like we have a draw with the dolphins average score being
//     ${averageDolphinScore} and the Koalas average score being ${koalaAverageScore}!`)
// }
